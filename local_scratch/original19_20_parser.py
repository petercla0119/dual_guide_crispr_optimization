# -*- coding: utf-8 -*-
"""dual_guide_parser_v8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nZ515X3FAI1ZlFoJuM8JJl4YcuJrb-b1
...
assert original_read_1_length >= guide_1_length, 'Oh no, read_1 is too small!'
assert original_read_2_length >= guide_2_length, 'Oh no, read_2 is too small!'
assert read_1_length == guide_1_length, 'Oh no, fix read_1 and g1!'
assert read_2_length == guide_2_length, 'Oh no, fix read_2 and g2!'
assert read_1_end - read_1_offset == read_1_length, 'Oh no, fix read_1 and g1!'
...
"""This next code block defines the r1 and r2 keys that are 19 BP, also making a reverse complement of r2 key."""
...
recombinant_pcnt = round((on_target/total_reads)*100, 2)
