...
# Return only reads in the counsensus group
...
# TODO: add feature to output if seq matches position A vs position B. likely will have to say if string matches before '_'
if check_reverse:
